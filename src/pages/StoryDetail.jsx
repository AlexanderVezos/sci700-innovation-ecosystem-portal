...
export default function StoryDetail() {
  ...
  if (loading) {
    return (
      <motion.div
        {...fade}
        className="h-full bg-slate-50 flex items-center justify-center"
      >
  ...
  if (notFound || !story) {
    return (
      <motion.div
        {...fade}
        className="h-full bg-slate-50 flex flex-col items-center justify-center gap-4 text-center px-8"
      >
