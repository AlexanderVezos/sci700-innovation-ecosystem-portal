        ...
        <div className="px-8 md:px-16 py-16 max-w-2xl mx-auto prose prose-slate prose-sm">
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed">
              StartupSC ("we", "us", "our") operates the Sunshine Coast
              Innovation Ecosystem Portal (the "Platform"). This Privacy Policy
              explains how we collect, use, store, and disclose personal
              information submitted through the Platform, in accordance with the{" "}
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed mt-3">
              ...
              Privacy Act) and do not require account registration to browse the
              Platform.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-slate-600 mt-2 space-y-1">
              ...
              <li>
                Review submissions for accuracy, legitimacy, and compliance with
                our Terms
              </li>
            ...
            <p className="text-slate-600 leading-relaxed mt-3">
              We will not use your information for direct marketing without your
              explicit consent, and we will not sell or rent your personal
          ...
          <section className="mb-8">
            <h2 className="text-lg font-bold text-slate-800 mb-2">
              4. Public Disclosure of Listings
            </h2>
            <p className="text-slate-600 leading-relaxed">
              Information submitted in startup, event, and opportunity listings
              (including any contact details you choose to provide) will be
              displayed publicly on the Platform once approved. By submitting a
              listing with contact details, you consent to that information
              being visible to other users of the Platform.
            </p>
            <p className="text-slate-600 leading-relaxed mt-3">
              You should only include contact information you are comfortable
              sharing publicly. Do not include personal home addresses or other
              sensitive personal details in listing descriptions.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed">
              Submitted data is stored in a cloud database hosted by MongoDB
              Atlas. We take reasonable technical and organisational measures to
              protect personal information from misuse, loss, unauthorised
              access, modification, or disclosure. However, no internet
          ...
          <section className="mb-8">
            ...
            <p className="text-slate-600 leading-relaxed">
              The Platform may use standard browser storage (such as
              localStorage) to remember your display preferences (e.g. reduced
              motion settings). We do not currently use third-party analytics
